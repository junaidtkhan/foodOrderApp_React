...
const ChatApp = () => {
  ...
  return (
    <div>
      {/* //Chat icon */}
      {/* write an inline property to set icon stick to bottom */}
      {!modalShow && <div style={{ bottom: "3%", right: "3%", position: "absolute", cursor: "pointer", position: 'fixed' }} onClick={() => setModalShow(true)}>
